	...
	<div id="content" class="row mx-auto">
        <div id="main-content" class="m-0 col-md-12 order-md-2 order-1 pt-3">
            ...
            <p class="default-line-height"><strong>The Barn</strong> is Sed accumsan congue
                Nulla dignissim nec augue Nunc ante elit nulla Aliquam suscipit consequat Cursus sed arcu sed Nulla dignissim nec augue Sed accumsan congue Nulla dignissim nec augue Nunc ante elit nulla</p>
            <p class="default-line-height"><strong><em>Enjoy Everyone! :)</em></strong></p>
            <h3 class="title title-h3">Lorem Ipsum Dolorem</h3>
            <p class="byline m-0">Posted in <a href="#">Philippines</a> by Joshua Rosalijos on the September 2nd, 2021</p>
            <p class="default-line-height"><img src="<?php echo base_url(); ?>assets/images/pages/img6.jpg" alt="" width="102" height="102" class="image float-start" /></p>
